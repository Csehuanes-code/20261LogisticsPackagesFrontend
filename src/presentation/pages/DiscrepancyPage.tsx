      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            <section className="rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
              <div className="mb-5 flex items-center gap-2.5">
                ...
                <h2 className="text-sm font-bold text-foreground">Datos del Paquete</h2>
              </div>
              <div className="grid gap-5 sm:grid-cols-3">
                <Field label="UUID">
                  <p className="font-mono text-sm font-semibold text-foreground">PRX-9823-UUID</p>
                </Field>
                <Field label="Status">
                ...
                <Field label="Cliente">
                  <p className="text-sm font-semibold text-foreground">TecnoSolutions S.A.</p>
                </Field>
              </div>
            </section>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <section className="rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
                <h3 className="mb-4 text-base font-bold text-foreground">Original (Sistema)</h3>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] italic text-muted-foreground">Largo × Ancho × Alto</p>
                  </div>
                </div>
              </section>
            ...
            <section className="rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
              <h3 className="mb-5 text-base font-bold text-foreground">Detalles de Discrepancia</h3>
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Select value={motivo} onValueChange={setMotivo}>
                    ...
                    <SelectContent>
                      <SelectItem value="error-pesaje">Error en pesaje</SelectItem>
                      <SelectItem value="error-dimensiones">Error en dimensiones</SelectItem>
                      <SelectItem value="empaque-modificado">Empaque modificado</SelectItem>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea rows={5} placeholder="Describa los hallazgos detalladamente..." />
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-6">
            <section className="rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
              <h3 className="mb-4 text-base font-bold text-foreground">Evidencia</h3>
              <label className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-border bg-secondary/40 px-4 py-10 text-center transition-colors hover:border-primary/60 hover:bg-primary/5">
                ...
                <span className="text-sm font-semibold text-foreground">Subir evidencia</span>
            ...
            <section className="rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
              <h3 className="mb-4 text-base font-bold text-foreground">Resumen</h3>
            ...
            <div className="flex gap-3 rounded-xl border border-primary/20 bg-primary/5 p-4">
              ...
              <div>
                <p className="text-sm font-bold text-foreground">Auditoría del sistema</p>
        ...
        <div className="mt-8 flex items-start gap-2 text-[11px] italic text-muted-foreground">
          ...
          La confirmación de la corrección dispara recálculo de precios automáticamente.
        </div>
      </main>
    </AppLayout>
  );
